...
namespace RwandaVSDC.Test.ModelsTests.JSON.Items.SelectItems
{
    public class ItemRequestTests
    {
        ...
        public void ShouldSerializeToJson()
        {
            ...
            ItemRequest testObject = new ItemRequest
            {
                Tin = "999991130",
                BranchId = "00",
        ...
        public void ShouldDeserializeFromJson()
        {
            ...
            // Act
            ItemRequest? model = jsonSerializer.Deserialize<ItemRequest>(json);
