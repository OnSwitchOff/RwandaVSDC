...
namespace RwandaVSDC.Test.ModelsTests.JSON.Imports.SelectImportItems
{
    public class ImportItemRequestTests
    {
        [Fact]
        public void ShouldSerializeToJson()
        {
            ...
            ImportItemRequest testObject = new ImportItemRequest
            {
                Tin = "999991130",
                BranchId = "00",
        ...
        public void ShouldDeserializeFromJson()
        {
            ...
            // Act
            ImportItemRequest? model = jsonSerializer.Deserialize<ImportItemRequest>(json);
