...
{
    public class SaveStockResponseTests
    {
        [Fact]
        public void ShouldSerializeToJson()
        {
            ...
            SaveStockResponse testObject = new SaveStockResponse
            {
                ResultCode = "000",
        ...
        public void ShouldDeserializeFromJson()
        {
            ...
            // Act
            SaveStockResponse? model = jsonSerializer.Deserialize<SaveStockResponse>(json);
