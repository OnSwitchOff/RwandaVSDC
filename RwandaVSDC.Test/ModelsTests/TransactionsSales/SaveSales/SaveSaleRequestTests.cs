...
using RwandaVSDC.Models.TransactionsSales.SaveSales;
...
namespace RwandaVSDC.Test.ModelsTests.TransactionsSales.SaveSales
{
    public class SaveSaleRequestTests
    {
        ...
        public void ShouldSerializeToJson()
        {
            ...
            SaveSaleRequest testObject = new SaveSaleRequest
            {
                Tin = "999999991",
                BranchId = "00",
                ...
                InvoiceNumber = 15,
                ItemList = new List<SaveSaleRequestItem>
                {
                    new SaveSaleRequestItem
                    {
                        Barcode = null,
                        DiscountAmount = 0,
                        DiscountRate = 0,
        ...
        public void ShouldDeserializeFromJson()
        {
            ...
            // Act
            SaveSaleRequest? model = jsonSerializer.Deserialize<SaveSaleRequest>(json);
